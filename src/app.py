'''
 # @ Create Time: 2023-11-29 22:20:35.045925
'''
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        values = success_counts['counts']
        title = 'Successful Launches for each Site'
    else:
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
...
def get_scatter_plot(entered_site,payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(spacex_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
                         title='Payload vs Success/Failure for all Sites', range_x=[low, high])
    else:
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
                         title=f'Payload vs Success/Failure for {entered_site}', range_x=[low, high])
